# Lead list, 2026-08-26

Every company below has a **verified published address**, found by grepping raw
HTML rather than trusting a broker. Nothing here is guessed.

Ratings are fit against her actual profile: pet care and edtech are the segments
she wants, founder's office and 0-1 ops is the work she does.

**Excluded on conflict:** Yulu, Zypp, Battery Smart, Rapido, Ather, BluSmart and
anything else in EV mobility, gig or rider services. That is a live conflict with
Bounce regardless of the moonlighting clearance.
...
|---|---|---|
| Muttley Crew | saywoof@muttleycrew.in | sent, best odds |
| Heads Up For Tails | rashi@headsupfortails.com | sent, broker address |
| Supertails | support@supertails.com | sent via support queue |
| Vetic | gaurav@vetic.in + support@vetic.in | sent both |
| PawSpace | connect@pawspace.in | sent |
| Dogsee Chew | hello@dogseechew.com | sent |
| Baseten | connor.peters@baseten.co | sent |
| Decawork | founders@decawork.ai | sent, YC S26 |
...
| Company | Route | Fit | Note |
|---|---|---|---|
| Ritivel | no address found | High | W26, 3 people, Bengaluru, AI for life sciences documentation. |
...
| Company | Route | Note |
|---|---|---|
| Otavo.ai | apply code X.1 on their site, do not DM | Rs 40-55 LPA remote, highest comp in the pipeline. |
| CarbonStrong | Google Form | Bengaluru, Rainmatter backed, so the Zerodha connection is real. |
| Medulance | LinkedIn link | Delhi, explicitly 0-1 years. |
